...
|---:|---|---|
| 0:00–0:24 | Use the retained genuine live-page clip to open the worked answer on **Analytical index of the answer**. Point to the three claims, their authoritative sources, observation dates and principal limitations. Keep the independent-prototype label visible. | Lead with the usable text-first evidence view: “See the evidence before the answer.” |
| 0:24–0:42 | Use the retained genuine live-page clip to move to **Evidence Trace** and follow one labelled path from answer to claim, source, transformation, check and limitation. | Show that the diagram explains the same deterministic index; it is not a generated narrative or a colour-only graphic. |
...
- on 30 August 2026, `Codex In-app Browser` discovered and successfully called
  ...
  and displayed SHA-256 digests matched; and
...
observation does not establish support in ChatGPT desktop, Chrome or another
host.
...
- Add accurate captions and publish a transcript.
- Show the exact final URL, genuine public-page interaction, the genuinely
  completed manual VoiceOver journey and the machine-level supported-host call
  receipt. Do not present the receipt visualisation as host chrome or a Site
  tools screenshot.
- Do not display account email, bookmarks, unrelated official tabs,
